...
pres.title   = "FlowNex360 — Manufacturing Execution System";
...
// ═══════════════════════════════════════════════════════════════════════════════
{
  ...
  // Title
  s.addText("Introducing FlowNex360", {
...
// ═══════════════════════════════════════════════════════════════════════════════
{
  ...
  s.addText("Companies using FlowNex360 QC report 60% reduction in customer rejections", {
    x: 0.30, y: 5.22, w: 9.40, h: 0.36,
...
// ═══════════════════════════════════════════════════════════════════════════════
{
  ...
  addSlideTitle(s, "Complete Factory Management — Not Just Production",
    "FlowNex360 covers every department in your factory");
...
// ═══════════════════════════════════════════════════════════════════════════════
{
  ...
  s.addText(
    "FlowNex360 runs on your factory's own server. Production tracking continues even with zero internet.\n\nWhen the connection restores, data syncs automatically to the cloud — no manual steps required.",
    {
...
// ═══════════════════════════════════════════════════════════════════════════════
{
  const s = pres.addSlide();
  s.background = { color: C.white };
  addSlideTitle(s, "Why FlowNex360?",
  ...
  ["Feature", "Generic ERP", "FlowNex360"].forEach((hdr, i) => {
...
// ═══════════════════════════════════════════════════════════════════════════════
{
  ...
  s.addText("FlowNex360 pays for itself within 60 – 90 days", {
    x: 0.4, y: 0.78, w: 9.2, h: 0.30,
    fontSize: 13.5, color: C.blue, fontFace: "Calibri", margin: 0,
  });
...
// ═══════════════════════════════════════════════════════════════════════════════
{
  ...
  s.addText("Your factory can be fully live on FlowNex360 in 3 weeks", {
    x: 0.4, y: 0.78, w: 9.2, h: 0.30,
    fontSize: 13.5, color: C.blue, fontFace: "Calibri", margin: 0,
  });
  ...
  s.addText([
    ...
    { text: "  |  ", options: { fontSize: 13, color: C.white, transparency: 40 } },
    { text: "  www.flownex360.com   ", options: { fontSize: 13, color: C.white } },
    { text: "  |  ", options: { fontSize: 13, color: C.white, transparency: 40 } },
    { text: "  demo.flownex360.com", options: { fontSize: 13, color: C.orange } },
  ], {
    x: 0.30, y: 4.28, w: 9.40, h: 0.82,
    align: "center", valign: "middle", fontFace: "Calibri", margin: 0,
  });
...
// ═══════════════════════════════════════════════════════════════════════════════
{
  ...
  addSlideTitle(s, "Hardware & Hosting Requirements",
    "What your factory needs to go live with FlowNex360");
...
// ─── WRITE FILE ───────────────────────────────────────────────────────────────
const outputPath = "D:/jms_enterprise/SAAS_LAUNCH/FlowNex360_CEO_v5.pptx";
